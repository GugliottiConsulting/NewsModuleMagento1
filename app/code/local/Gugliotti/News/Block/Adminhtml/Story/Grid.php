...
class Gugliotti_News_Block_Adminhtml_Story_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn(
			...
			array(
				...
				'width' => 150,
				'type' => 'options',
				'options' => Mage::getModel('gugliotti_news/source_categories')->toGridArray(),
			)
		);
		$this->addColumn(
			'status',
			array(
				...
				'width' => 50,
				'type' => 'options',
				'options' => Mage::getModel('gugliotti_news/source_status')->toGridArray(),
	...
	protected function _prepareMassaction()
	{
		...
		$this->getMassactionBlock()->setFormFieldName('stories');
